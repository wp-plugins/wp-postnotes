<?php
class dc_wp_post_1_0_0 extends dc_base_1_0_2 {
	...
	function flatten()
	{
		$posts=get_posts(array('post_status'=>'draft','numberposts'=>99999999));
		foreach($posts as $post)
		{
			wp_delete_post($post->ID);
		}
//		$posts=get_posts(array('post_type'=>'page','numberposts'=>99999999));
//			foreach($posts as $post)
//			{
//				wp_delete_post($post->ID);
//			}
